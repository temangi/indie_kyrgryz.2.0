...
const forEx = { duration: 300, price: 1000 };
...
const HowItGoing = () => {
    ...
    if (!currentTour) {
        return <section className={styles.notFound}><h2>Tour not found</h2></section>;
    }
                    ...
                    <div className={styles.tourDetails__layout}>
                        ...
                        <aside className={styles.tourDetails__sidebar}>
                            <div className={styles.stickyBox}>
                                ...
                                <button className={styles.bookBtn} onClick={openModal} >Contact Us</button>
                            </div>
                        </aside>
